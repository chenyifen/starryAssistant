...
import com.ai.voice.settings.datastore.AudioQuality
...
import com.ai.voice.settings.ui.BooleanSetting
import com.ai.voice.settings.ui.ListSetting
...
fun inputDevice() = ListSetting(
    ...
    possibleValues = listOf(
        ...
        ListSetting.Value(
            value = InputDevice.INPUT_DEVICE_SHERPA_SIMULATE,
            name = stringResource(R.string.pref_input_method_sherpa_simulate),
            description = stringResource(R.string.pref_input_method_sherpa_simulate_summary),
            icon = Icons.Default.Mic,
        ),
        ListSetting.Value(
