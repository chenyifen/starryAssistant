...
#
# 示例:
#   ./resign_apk.sh -a app.apk -k release.keystore -s android123 -n release
#   ./resign_apk.sh --apk app.apk --keystore release.keystore --storepass android123 --keypass android123 --alias release
