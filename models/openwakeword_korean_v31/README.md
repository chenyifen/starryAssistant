# 韩语唤醒词模型 V31 - OpenWakeWord格式

这是为Dicio Android应用创建的韩语唤醒词"하이넛지"(Hi Nutji)的OpenWakeWord格式模型V31版本。

## 模型信息

- **唤醒词**: 하이넛지 (Hi Nutji)
- **语言**: 韩语 (ko-KR)
- **框架**: OpenWakeWord + TensorFlow Lite
- **版本**: 3.1.0
- **创建日期**: 2025-10-23
...
- **优化策略**: 方案A: 控制数据规模 + 降低权重
- **优化基础**: OpenWakeWord源码分析
- **正样本数量**: 500
- **负样本数量**: 500
- **最大负权重**: 5 (相比之前降低90%)
